...
export declare class AlgorithmsFactory {
    static create(stocksService: StocksServiceInterface, transactionsService: TransactionServiceInterface, PlataformActivitiesService: PlataformActivitiesServiceInterface, gameService: GamesServiceInterface): AlgorithmsServicesInterface;
}
